...
with DAG(
    ...
    ingestion = BashOperator(
        ...
        env={
            ...
            "AWS_ENDPOINT_URL": "http://10.140.0.4:9001"
        },
        bash_command="""
            aws --endpoint-url $AWS_ENDPOINT_URL s3 cp /home/n3cr0d3m0nncrdmn/data/yellow_tripdata_2025.parquet s3://bronze/raw/yellow_tripdata_2025.parquet
            aws --endpoint-url $AWS_ENDPOINT_URL s3 cp /home/n3cr0d3m0nncrdmn/data/taxi_zone_lookup.csv s3://bronze/raw/taxi_zone_lookup.csv
        """
    )
